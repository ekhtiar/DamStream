...
def createdag(pipelinename, scheduleinterval):
    ...
    fo.write("from datetime import datetime \n")
    fo.write('sys.path.append("/root/DSadapter/")')
    ...
    fo.write(pythonoperator(task_id='pull_' + pipelinename,
                            python_callable='pull("' + pipelinename + '")',
                            op_kwargs='op_kwargs ={"dplname":"payconiq"}'))
